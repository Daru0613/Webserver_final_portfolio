    ...
    <div className="relative w-full bg-gray-200">
        ...
        <div className="relative w-[1100px] h-[900px]">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <button
              ...
              className="w-56 h-56 rounded-full bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 text-white font-bold text-4xl shadow-2xl hover:scale-110 transition-all duration-300 flex items-center justify-center border-4 border-white/50"
            >
              김서진
            </button>
          </div>
              ...
              <div key={node.id}>
                ...
                >
                  <div className="group relative">
                    <div className="w-44 h-44 rounded-full bg-white/90 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110 flex flex-col items-center justify-center border-3 border-gray-700 cursor-pointer">
                      <div className="text-base font-bold text-gray-800">{node.label}</div>
                      <div className="text-sm text-gray-600 mt-2 px-4 text-center">{node.content}</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="relative z-10 py-20">
        <div className="w-full max-w-5xl mx-auto px-8">
          <h2 className="text-6xl font-bold text-gray-800 text-center mb-20">Education</h2>
              ...
              <div key={index} className="relative mb-32 last:mb-0">
                ...
                <div className={`flex ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                  <div className={`w-[45%] ${index % 2 === 0 ? 'pr-12 text-right' : 'pl-12 text-left'}`}>
                    {/* 연도 표시 (큰 글씨) */}
                    <div className="text-gray-400 text-lg mb-2">{item.period}</div>
